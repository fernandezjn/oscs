      ...
      <nav class="fixed-top align-top" id="sidebar-wrapper" role="navigation">
        <div class="simplebar-content" style="padding: 0px;">
          ...
          <ul class="navbar-nav align-self-stretch">
            ...
            <li class=""><a href="#" class="nav-link text-left" role="button"><i class="fa fa-clipboard"></i> Clearance Records</a></li>
      
            <li class=""><a href="#" class="nav-link text-left" role="button"><i class="fas fa-file-signature"></i>Clearance Form</a></li>
          </ul>
        </div>
      </nav>
      <!-- /#sidebar-wrapper -->
                      ...
                      <div class="col-sm-12">
                        <form>  
                          <div class="text-center mb-5">
                            <img src="http://ssl.gstatic.com/accounts/ui/avatar_2x.png" class="avatar rounded-circle img-thumbnail" alt="avatar" style="width:160px; height:160px;">
                          </div>
                          <hr>
