...
<html lang="en">
	<head>
    	...
    	<title>Reset Password | Online Student Clearance System</title>
  		...
  		<div class="reset-pass text-center">
	  		<div id="form-group">
	    		<form class="form-reset-pass" method="POST">
	      			...
	      			<h4 class="h5 mb-4 font-weight-normal">Reset your Password</h4>
	      			<div class="mb-2">
	     			 	<input type="password" id="inputNewPassword" class="form-control" placeholder="New Password" name="newPassInput" required autofocus>
					</div>
